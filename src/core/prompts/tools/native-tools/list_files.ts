...
Parameters:
- path: The directory to list (relative to the current workspace directory). If omitted or empty, defaults to "." (workspace root).
- recursive: Whether to list files recursively. Use true for recursive listing, false for top-level only. If omitted, defaults to false.

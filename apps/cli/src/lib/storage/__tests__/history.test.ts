...
import { getHistoryFilePath, loadHistory, saveHistory, addToHistory, MAX_HISTORY_ENTRIES } from "../history.ts"
...
describe("historyStorage", () => {
	...
	describe("getHistoryFilePath", () => {
		it("should return the correct path to cli-history.json", () => {
			...
			expect(result).toBe(path.join("/home/testuser", ".njust_ai", "cli-history.json"))
		})
	})
	...
	describe("saveHistory", () => {
		it("should create directory and save history", async () => {
			...
			expect(fs.mkdir).toHaveBeenCalledWith(path.join("/home/testuser", ".njust_ai"), { recursive: true })

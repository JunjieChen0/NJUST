...
import type { ExtensionMessage, WebviewMessage, ClineAskResponse, ClineMessage, ClineAsk } from "@njust-ai-cj/types"
...
/**
 * ExtensionClient is the main interface for interacting with the NJUST_AI_CJ extension.
 *
 * Basic usage:
 * ```typescript

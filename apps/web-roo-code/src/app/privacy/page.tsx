...
const DESCRIPTION =
	"Privacy policy for NJUST_AI_CJ Cloud and marketing website. Learn how we handle your data and protect your privacy."
			...
			<div className="container mx-auto px-4 py-12 sm:px-6 lg:px-8">
				<div className="prose prose-lg mx-auto max-w-4xl dark:prose-invert">
					<h1 className="text-3xl font-bold tracking-tight sm:text-4xl md:text-5xl">
						NJUST_AI_CJ Cloud Privacy Policy
					</h1>
					<p className="text-muted-foreground">Last Updated: September 19, 2025</p>

					<p className="lead">
						This Privacy Policy explains how NJUST_AI_CJ, Inc. (&quot;NJUST_AI_CJ,&quot; &quot;we,&quot;
					...
					<div className="my-8 rounded-lg border border-border bg-muted/50 p-6">
						...
						<p className="mb-0">
							...
							<a
								...
								NJUST_AI_CJ Extension Privacy Policy
							</a>
							.
						</p>
					</div>
					...
					<ul>
						<li>
							<strong>
								Your source code does not transit NJUST_AI_CJ servers unless you explicitly choose NJUST_AI_CJ
								as a model provider (proxy mode).
							</strong>{" "}
							When NJUST_AI_CJ Cloud is your model provider, your code briefly transits NJUST_AI_CJ servers only
							...
							TLS—to the model you select. NJUST_AI_CJ never stores, inspects, or trains on your code.
						</li>
						<li>
							<strong>Prompts and chat snippets are collected by default</strong> in NJUST_AI_CJ Cloud so you
							can search and re‑use past conversations. Organization admins can disable this collection at
							any time.
						</li>
						<li>
							We collect only the data needed to operate NJUST_AI_CJ Cloud, do <strong>not</strong> sell
					...
					<ul>
						<li>
							<strong>Operate & secure NJUST_AI_CJ Cloud</strong> (authentication, completions, abuse
							prevention)
						</li>
						<li>
						...
						<table className="min-w-full border-collapse border border-border">
							...
							<tbody>
								<tr>
									...
									<td className="border border-border px-4 py-2">
										Your chosen model provider (direct client → provider TLS), or NJUST_AI_CJ (proxy
										mode; transit‑only) when you select NJUST_AI_CJ as the provider
									</td>
									<td className="border border-border px-4 py-2">
										NJUST_AI_CJ servers (except proxy mode; transit‑only, no storage); ad networks;
								...
								<tr className="bg-muted/25">
									...
									<td className="border border-border px-4 py-2">
										NJUST_AI_CJ Cloud (encrypted at rest)
									</td>
								...
								<tr>
									...
									<td className="border border-border px-4 py-2">
										NJUST_AI_CJ servers (we store only the Stripe customer ID)
									</td>
								</tr>
							</tbody>
						</table>
					...
					<ul>
						<li>
							<strong>Source Code:</strong> Never stored on NJUST_AI_CJ servers.
						</li>
						<li>
					...
					<ul>
						...
						<li>
							...
							<strong>Security Settings</strong> inside NJUST_AI_CJ Cloud (User Menu &rarr; My Settings
							&rarr; Open Profile).
						</li>
						<li>

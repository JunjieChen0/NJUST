...
const TITLE = "NJUST_AI_CJ for Linear"
const DESCRIPTION = "Assign development work to @NJUST_AI_CJ directly from Linear. Get PRs back without switching tools."
...
const VALUE_PROPS: ValueProp[] = [
	{
		...
		description:
			"Assign development work to @NJUST_AI_CJ directly from Linear. No new tools to learn, no context switching required.",
	},
	{
		icon: Eye,
		title: "Progress is visible.",
		description:
			"Watch progress unfold in real-time. NJUST_AI_CJ posts updates as comments, so your whole team stays in the loop.",
	},
	{
		icon: MessageSquare,
		title: "Mention for refinement.",
		description:
			'Need changes? Just comment "@NJUST_AI_CJ also add dark mode support" and the agent picks up where it left off.',
	},
	{
		icon: Link2,
	...
	},
	{
		...
		description:
			"Connect once, use everywhere. Your team members can assign issues to @NJUST_AI_CJ without individual configuration.",
	},
	{
		icon: Shield,
...
// 	{
// 		step: 2,
// 		title: "Call @NJUST_AI_CJ",
// 		description: "Mention @NJUST_AI_CJ in a comment to start. The agent begins working immediately.",
// 	},
// 	{
// 		step: 3,
// 		title: "Watch progress",
// 		description: "NJUST_AI_CJ posts status updates as comments. Refine with @-mentions if needed.",
// 	},
// 	{
// 		step: 4,
// 		title: "Review the PR",
...
const ONBOARDING_STEPS: OnboardingStep[] = [
	...
	},
	{
		...
		description: "Link your repositories so NJUST_AI_CJ can open PRs on your behalf.",
	},
	{
		icon: Settings,
	...
	},
	{
		icon: CheckCircle,
		title: "4. Link & Start",
		description: "Map your Linear project to a repo, then assign or mention @NJUST_AI_CJ.",
	},
]
					...
					<div className="grid w-full max-w-6xl grid-cols-1 items-center gap-10 lg:grid-cols-2 lg:gap-12">
						<div className="text-center lg:text-left">
							...
							<p className="text-xl text-muted-foreground mb-8 max-w-2xl mx-auto lg:mx-0">
								Assign development work to @NJUST_AI_CJ directly from Linear. Get PRs back without
								switching tools.
							</p>
				...
				<div className="container mx-auto px-4 sm:px-6 lg:px-8 relative">
					...
					<div className="text-center mb-16">
						<h2 className="text-3xl font-bold tracking-tight sm:text-4xl mb-4">
							Why your team will love using NJUST_AI_CJ in&nbsp;Linear
						</h2>
			...
			<section id="demo" className="relative overflow-hidden border-t border-border py-24 lg:py-32">
				<div className="container relative z-10 mx-auto px-4 sm:px-6 lg:px-8">
					...
					<div className="mx-auto mb-12 max-w-5xl text-center">
						...
						<p className="text-xl text-muted-foreground max-w-2xl mx-auto">
							Stay in Linear from assignment to review. NJUST_AI_CJ keeps the issue updated and links the PR
							when it&apos;s ready.
						</p>
					</div>
			...
			{/*<div className="lg:col-span-3 overflow-hidden rounded-2xl border border-border bg-background shadow-lg">
								{LINEAR_DEMO_YOUTUBE_ID ? (
									<iframe
										...
										title="NJUST_AI_CJ Linear Integration Demo"
									...
									<div className="aspect-video w-full flex flex-col items-center justify-center bg-gradient-to-br from-indigo-500/10 via-blue-500/5 to-purple-500/10 text-center p-8">
										...
										<p className="text-sm text-muted-foreground max-w-md">
											See the workflow in action: assign an issue to @NJUST_AI_CJ and watch as it
				...
				<div className="container mx-auto px-4 sm:px-6 lg:px-8">
					<div className="mx-auto max-w-4xl rounded-3xl border border-border/50 bg-gradient-to-br from-indigo-500/10 via-purple-500/5 to-blue-500/5 p-8 text-center shadow-2xl backdrop-blur-xl dark:border-white/10 sm:p-16">
						<h2 className="mb-6 text-3xl font-bold tracking-tight sm:text-4xl">
							Start using NJUST_AI_CJ in Linear
						</h2>

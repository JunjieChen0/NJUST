...
const DESCRIPTION = "Learn about how NJUST_AI_CJ uses cookies to enhance your experience and provide our services."
		...
		<>
			<div className="container mx-auto px-4 py-12 sm:px-6 lg:px-8">
				<div className="prose prose-lg mx-auto max-w-4xl dark:prose-invert">
					...
					<p className="lead">
						This Cookie Policy explains how NJUST_AI_CJ uses cookies and similar technologies to recognize you

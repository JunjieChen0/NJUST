...
const TITLE = "NJUST_AI_CJ for Slack"
const DESCRIPTION =
...
const ONBOARDING_STEPS: OnboardingStep[] = [
	...
	},
	{
		icon: Settings,
		title: "2. Connect",
		description: 'Sign in to NJUST_AI_CJ Cloud and go to Settings. Click "Connect" next to Slack.',
	},
	{
		icon: Slack,
		title: "3. Authorize",
		description: "Authorize the NJUST_AI_CJ app to access your Slack workspace.",
	},
	{
		icon: MessageSquare,
				...
				<div className="container mx-auto px-4 sm:px-6 lg:px-8 relative">
					...
					<div className="text-center mb-16">
						<h2 className="text-3xl font-bold tracking-tight sm:text-4xl mb-4">
							Why your team will love using NJUST_AI_CJ in&nbsp;Slack
						</h2>
						...
						<div className="grid grid-cols-1 lg:grid-cols-5 gap-8 lg:gap-10 items-center">
							...
							<div className="lg:col-span-3 overflow-hidden rounded-2xl border border-border bg-background shadow-lg">
								<iframe
									...
									title="NJUST_AI_CJ Slack Integration Demo"
				...
				<div className="container mx-auto px-4 sm:px-6 lg:px-8">
					<div className="mx-auto max-w-4xl rounded-3xl border border-border/50 bg-gradient-to-br from-violet-500/10 via-purple-500/5 to-blue-500/5 p-8 text-center shadow-2xl backdrop-blur-xl dark:border-white/10 sm:p-16">
						<h2 className="mb-6 text-3xl font-bold tracking-tight sm:text-4xl">
							Start using NJUST_AI_CJ in Slack
						</h2>

...
const faqs = [
	...
	{
		question: "What is the NJUST_AI_CJ Router?",
		answer: (
			<>
				<p>This is our very own model router, optimized to work seamlessly with NJUST_AI_CJ Cloud.</p>
				<p>You don&apos;t have to use it to use NJUST_AI_CJ, but it&apos;s the easiest way to do it.</p>
			</>
		),
	},
	{
		question: "Do I have to use the NJUST_AI_CJ Router to use the NJUST_AI_CJ products?",
	...
	},
	{
		...
		answer: "The NJUST_AI_CJ Router doesn't keep any of your data, the service only aims to make it easier to use NJUST_AI_CJ. Each model vendor has their own privacy policy though, and usually free models use your data for training, so keep that in mind.",
	},
	{
		question: "How much does the NJUST_AI_CJ Cloud service cost?",
		answer: (
			<>
				Our{" "}
			...
			<section className="relative overflow-hidden py-16">
				<div className="container relative z-10 mx-auto px-4 sm:px-6 lg:px-8">
					<div className="text-center">
						<h1 className="text-4xl md:text-5xl font-bold tracking-tight">The NJUST_AI_CJ Router</h1>
						<p className="mx-auto mt-4 max-w-3xl md:text-lg text-muted-foreground">
							The easiest way to use NJUST_AI_CJ (in the{" "}

...
export const content: AgentPageContent = {
	...
	hero: {
		...
		paragraphs: [
			...
			"NJUST_AI_CJ's PR Reviewer uses advanced reasoning models and full repository context to find the issues that slip through—before they reach production.",
		],
		image: {
			url: hero.src,
			width: 800,
			height: 474,
			alt: "Example of a code review generated by NJUST_AI_CJ PR Reviewer",
		},
		crossAgentLink: {
	...
	howItWorks: {
		...
		steps: [
			...
			},
			{
				...
				description:
					"Every pull request gets detailed GitHub comments in minutes from a NJUST_AI_CJ agent highlighting issues and suggesting improvements.",

...
const TITLE = "NJUST_AI_CJ Pricing"
const DESCRIPTION =
	"Simple, transparent pricing for all NJUST_AI_CJ products. The VS Code extension is free forever. Choose the cloud plan that fits your needs."
...
const pricingTiers: PricingTier[] = [
	...
	},
	{
		...
		features: [
			...
			"Access to the NJUST_AI_CJ Router",
			...
			<section className="relative overflow-hidden pt-12 pb-10">
				<div className="container relative z-10 mx-auto px-4 sm:px-6 lg:px-8">
					<div className="text-center">
						<h1 className="text-5xl font-bold tracking-tight">NJUST_AI_CJ Pricing</h1>
						<p className="mt-4 text-lg text-muted-foreground">
							For all of our products: the NJUST_AI_CJ VS Code Extension, NJUST_AI_CJ Cloud and the NJUST_AI_CJ
							Router.
						</p>
					</div>
				</div>
				...
				<div className="container mx-auto px-4 sm:px-6 lg:px-8">
					...
					<div className="max-w-6xl mx-auto mt-8 p-7 flex flex-col md:flex-row gap-8 md:gap-4 bg-violet-200/20 outline-violet-700/20 outline outline-1 rounded-2xl transition-all shadow-none">
						<div className="md:border-r md:pr-4">
							<h3 className="text-lg font-medium mb-1">NJUST_AI_CJ Router</h3>
							<div className="text-sm text-muted-foreground">
								<p className="">
									On any plan, you can use your own LLM provider API key or use the built-in NJUST_AI_CJ
				...
				<div className="container mx-auto px-4 sm:px-6 lg:px-8">
					...
					<div className="mx-auto mt-12 grid max-w-5xl gap-8 md:grid-cols-2">
						<div className="rounded-xl border border-border bg-card p-6">
							<h3 className="font-semibold">Wait, is NJUST_AI_CJ free or not?</h3>
							<p className="mt-2 text-sm text-muted-foreground">
								Yes! The NJUST_AI_CJ VS Code extension is open source and free forever. The extension acts
						...
						<div className="rounded-xl border border-border bg-card p-6">
							...
							<p className="mt-2 text-sm text-muted-foreground">
								NJUST_AI_CJ Cloud credits can be used in two ways:
							</p>
			...
			<section className="py-20">
				<div className="container mx-auto px-4 sm:px-6 lg:px-8">
					<div className="mx-auto max-w-4xl rounded-3xl border border-border/50 bg-gradient-to-br from-blue-500/5 via-cyan-500/5 to-purple-500/5 p-8 text-center shadow-2xl backdrop-blur-xl dark:border-white/20 dark:bg-gradient-to-br dark:from-gray-800 dark:via-gray-900 dark:to-black sm:p-12">
						<h2 className="mb-4 text-3xl font-bold tracking-tight sm:text-4xl">Try NJUST_AI_CJ Cloud now</h2>

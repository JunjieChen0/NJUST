...
const features: Feature[] = [
	...
	},
	{
		...
		description: "Bring your own keys or use the NJUST_AI_CJ Router with access to all top models with no markup.",
	},
	{
		icon: Github,
	...
	},
	{
		...
		description: "Assign issues to NJUST_AI_CJ directly from Linear. Get PRs back without switching tools.",
	},
	{
		icon: Users,
			...
			<section className="relative flex pt-32 pb-20 items-center overflow-hidden">
				...
				<div className="container relative flex flex-col items-center h-full z-10 mx-auto px-4 sm:px-6 lg:px-8">
					...
					<div className="relative mx-auto mt-4 md:max-w-[1000px]">
						<Image
							src={screenshotDark}
							alt="NJUST_AI_CJ Cloud Interface"

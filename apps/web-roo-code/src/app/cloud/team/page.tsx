...
const TITLE = "NJUST_AI_CJ Cloud Team Plan"
const DESCRIPTION =
...
const keyBenefits = [
	...
	},
	{
		...
		description:
			"Single billing point for all team members using Cloud Agents and the NJUST_AI_CJ Router. No more API key management.",
		icon: DollarSign,
	},
	{
			...
			<section className="relative flex pt-32 pb-20 items-center overflow-hidden">
				...
				<div className="container relative flex flex-col items-center h-full z-10 mx-auto px-4 sm:px-6 lg:px-8">
					<div className="text-center max-w-4xl mx-auto mb-12">
						<h1 className="text-4xl font-bold tracking-tight mb-6 md:text-6xl">NJUST_AI_CJ Cloud Team</h1>

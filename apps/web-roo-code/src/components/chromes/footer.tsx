			...
			<div className="mx-auto max-w-7xl px-6 pb-6 pt-12 md:pb-8 md:pt-16 lg:px-8">
				<div className="xl:grid xl:grid-cols-3 xl:gap-8">
					<div className="space-y-8">
						<div className="flex items-center">
							<Image src={logoSrc} alt="NJUST_AI_CJ Logo" width={120} height={40} className="h-6 w-auto" />
						</div>
						...
						<a
							...
							<Image
								src={resolvedTheme === "light" ? "/NJUST_AI_CJ-Badge-blk.svg" : "/NJUST_AI_CJ-Badge-white.svg"}
								alt="Made with NJUST_AI_CJ"
								width={120}
								height={40}
				...
				<div className="mt-16 flex border-t border-border pt-8 sm:mt-20 lg:mt-24">
					<p className="mx-auto text-sm leading-5 text-muted-foreground">
						&copy; {new Date().getFullYear()} NJUST_AI_CJ. All rights reserved.
					</p>
				</div>
			</div>
		</footer>

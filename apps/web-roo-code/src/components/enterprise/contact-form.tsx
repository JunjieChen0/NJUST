...
export function ContactForm({ formType, buttonText, buttonClassName }: ContactFormProps) {
	...
	const formDescription =
		formType === "early-access"
			? "Fill out the form below to collaborate in shaping NJUST_AI_CJ's enterprise solution."
			: "Fill out the form below to see NJUST_AI_CJ's enterprise capabilities in action."

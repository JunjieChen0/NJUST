...
const faqs: FAQItem[] = [
	{
		question: "What exactly is NJUST_AI_CJ?",
		answer: (
			<>
				NJUST_AI_CJ is an open-source, AI-powered coding assistant that runs in VS Code. It goes beyond simple
	...
	{
		question: "How does NJUST_AI_CJ differ from Copilot, Cursor, or Windsurf?",
		answer: (
			<>
				NJUST_AI_CJ is <strong>open-source and fully customizable</strong>, letting you integrate any AI model you
				...
				browser, and handle deeper tasks. And you&apos;re always in control: NJUST_AI_CJ is{" "}
	...
	{
		question: "Is NJUST_AI_CJ really free?",
		answer: (
			<>
				Yes! NJUST_AI_CJ is completely free and open-source. You&apos;ll only pay for the AI model usage if you use
	...
	},
	{
		...
		answer: (
			<>
				Yes. Because NJUST_AI_CJ is an extension in your local VS Code, your code never leaves your machine unless
				you connect to an external AI API. Even then, you control exactly what is sent to the AI model. You can
				use tools like .rooignore to exclude sensitive files, and you can also run NJUST_AI_CJ with offline/local
				models for full privacy.
			</>
		),
	},
	{
		question: "Which AI models does NJUST_AI_CJ support?",
		answer: (
			<>
				NJUST_AI_CJ is fully model-agnostic, giving you the flexibility to work with whatever AI models you prefer.
				...
				connect any other model that follows NJUST_AI_CJ&apos;s Model Context Protocol (MCP).
			</>
		),
	},
	{
		question: "Does NJUST_AI_CJ support my programming language?",
		answer: (
			<>
				Likely yes! NJUST_AI_CJ supports a wide range of languages—Python, Java, C#, JavaScript/TypeScript, Go,
	...
	},
	{
		...
		answer: (
			<>
				Install NJUST_AI_CJ from the{" "}
				<a
					href="https://marketplace.visualstudio.com/items?itemName=RooVeterinaryInc.njust-ai-cj"
					target="_blank"
				...
				<a
					href="https://docs.njust-ai-cj.local/tutorial-videos"
					target="_blank"
					rel="noopener noreferrer"
					className="text-primary underline-offset-4 hover:underline">
	...
	},
	{
		...
		answer: (
			<>
				Absolutely. NJUST_AI_CJ uses efficient strategies (like partial-file analysis, summarization, or
				...
				<Link href="/enterprise" className="text-primary underline-offset-4 hover:underline">
					Learn more about NJUST_AI_CJ for enterprise.
				</Link>
			</>
		),
	},
	{
		...
		answer: (
			<>
				Yes. NJUST_AI_CJ was built for enterprise environments. You can self-host AI models or use your own trusted
				provider. All file changes and commands go through permission gating, so nothing runs without your
				approval. And because NJUST_AI_CJ is fully open-source, it&apos;s auditable—you can review exactly how it
				works before deploying it.{" "}
				<a
					href="https://njust-ai-cj.local/enterprise"
					target="_blank"
					rel="noopener noreferrer"
					className="text-primary underline-offset-4 hover:underline">
					Learn more about NJUST_AI_CJ for enterprise.
	...
	{
		question: "Can NJUST_AI_CJ run commands and tests automatically?",
		answer: (
			<>
				Yes! One of NJUST_AI_CJ&apos;s biggest strengths is its ability to execute commands—always optional and
	...
	},
	{
		...
		answer: (
			<>
				NJUST_AI_CJ shines for both serious enterprise development and casual &quot;vibe coding.&quot; You can ask
	...
	{
		question: "Can I contribute to NJUST_AI_CJ?",
		answer: (
			<>
				Yes, please do! NJUST_AI_CJ is open-source on{" "}
				<a
					href="https://github.com/NJUST-AI/NJUST_AI_CJ"
					target="_blank"
					rel="noopener noreferrer"
					className="text-primary underline-offset-4 hover:underline">
					GitHub
				...
				<a
					href="https://discord.gg/njust-ai-cj"
					target="_blank"
					rel="noopener noreferrer"
					className="text-primary underline-offset-4 hover:underline">
					Discord
				...
				and{" "}
				<a
					href="https://reddit.com/r/NJUST_AI_CJ"
					target="_blank"
					rel="noopener noreferrer"
					className="text-primary underline-offset-4 hover:underline">
					Reddit
	...
	},
	{
		...
		answer: (
			<>
				Check out our{" "}
				<a
					href="https://docs.njust-ai-cj.local"
					target="_blank"
					rel="noopener noreferrer"
					className="text-primary underline-offset-4 hover:underline">
				...
				<a
					href="https://www.youtube.com/@NJUST_AI_CJYT"
					target="_blank"
					rel="noopener noreferrer"
					className="text-primary underline-offset-4 hover:underline">
					YouTube
				...
				<div className="mx-auto mb-24 max-w-3xl text-center">
					<motion.div
						...
						<p className="mt-6 text-lg text-muted-foreground max-w-2xl mx-auto">
							Everything you need to know about NJUST_AI_CJ and how it can transform your development
							workflow.
						</p>
					</motion.div>
				</div>

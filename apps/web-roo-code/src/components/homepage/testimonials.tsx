...
export const testimonials: Testimonial[] = [
	{
		...
		quote: "NJUST_AI_CJ is an absolute game-changer! 🚀 It makes coding faster, easier, and more intuitive with its smart AI-powered suggestions, real-time debugging, and automation features. The seamless integration with VS Code is a huge plus, and the constant updates ensure it keeps getting better",
		stars: 5,
	},
	{
		...
		origin: "Vendidit",
		quote: "Easily the best AI code editor. NJUST_AI_CJ has the best features and capabilities, along with the best development team. I swear, they're the fastest to support new models and implement useful functionality whenever users mention it... simply amazing.",
	},
	{
		name: "Can Nuri",
		role: "Reviewer",
		origin: "VS Code Marketplace",
		quote: "NJUST_AI_CJ is one of the most inspiring projects I have seen for a long time. It shapes the way I think and deal with software development.",
		stars: 5,
	},
	{
		name: "Michael",
		role: "Reviewer",
		origin: "VS Code Marketplace",
		quote: "I switched from Windsurf to NJUST_AI_CJ in January and honestly, it's been a huge upgrade. Windsurf kept making mistakes and being dumb when I ask it for things. Roo just gets it. Projects that used to take a full day now wrap up before lunch. ",
		stars: 5,
	},
	{
		name: "Darien Hardin",
	...
	},
	{
		...
		role: "Reviewer",
		origin: "VS Code Marketplace",
		quote: "I've tried Cursor, Windsurf, Cline, Trae and others, and although using NJUST_AI_CJ with OpenRouter is more expensive, it is also far more effective. Its agents and initial setup, and learning how to use Code/Architect/Orchestrator, help a great deal in developing quality projects.",
		stars: 5,
	},
	{
		name: "Matěj Zapletal",
	...
	},
	{
		...
		role: "Reviewer",
		origin: "VS Code Marketplace",
		quote: "NJUST_AI_CJ is impressively capable while staying refreshingly simple. It integrates seamlessly into VS Code and handles everything from generating code to refactoring with accuracy and speed. It feels like a natural part of the workflow—no clutter, just results. Extra points for the flexibility of the different agents and the ability to customize them to fit the job.",
		stars: 5,
	},
	{
		name: "Colin Tate",
	...
	},
	{
		...
		role: "Reviewer",
		origin: "VS Code Marketplace",
		quote: "I've used all the IDEs and all the assistants - NJUST_AI_CJ is hands down the best of them. It's also one of the few that lets you bring your own API keys - no subscriptions required, just pay as you need/go! Fantastic team and support as well!",
		stars: 5,
	},
]

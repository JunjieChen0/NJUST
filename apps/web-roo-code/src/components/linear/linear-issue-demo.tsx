...
export function LinearIssueDemo({ className }: LinearIssueDemoProps): JSX.Element {
		...
		() => [
			{
				...
				body: (
					<span>
						<span className="text-indigo-400">@NJUST_AI_CJ</span> Can you implement this feature?
					</span>
				),
				timeLabel: "2m ago",
			},
			...
			},
			{
				...
				body: (
					<span>
						<span className="text-indigo-400">@NJUST_AI_CJ</span> Please also add a &quot;system&quot; option
			...
			},
			{
				...
				body: (
					<span>
						<span className="text-[#F8F8F9]">NJUST_AI_CJ</span> linked{" "}
	...
	return (
		<div
			...
			role="img"
			aria-label="Animated Linear issue showing NJUST_AI_CJ responding to a comment">
			<div
				aria-hidden="true"

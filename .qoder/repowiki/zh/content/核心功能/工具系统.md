...
Roo-Code 的工具系统是一个高度模块化和可扩展的框架，用于支持智能代理与环境的交互。该系统提供了统一的工具抽象基类、内置工具实现、工具验证机制和工具执行器，能够处理文件读写、命令执行、代码搜索等多种操作。
...
Roo-Code 的工具系统通过精心设计的架构和丰富的功能特性，为智能代理提供了强大而安全的工具调用能力。系统的主要优势包括：

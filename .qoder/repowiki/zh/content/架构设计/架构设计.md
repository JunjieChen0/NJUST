...
Roo-Code 是一个基于 VS Code 的 AI 编程助手扩展，采用 Webview 与扩展宿主分离的架构设计。该项目专注于提供智能代码辅助、任务编排和云端协作能力，支持多种 AI 模型提供商和本地/云端混合工作模式。
...
Roo-Code 项目采用了先进的分离式架构设计，通过 Webview 与扩展宿主的清晰分离，实现了高性能、高可用的 AI 编程助手系统。其核心优势包括：

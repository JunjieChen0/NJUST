...
工具组管理系统是Roo-Code平台的核心功能模块，负责管理和控制AI助手可以使用的各种工具。该系统提供了强大的工具权限控制、工具分类管理、工具可用性检查等功能，支持内置工具组的灵活组织和动态工具加载机制。
...
工具组管理系统通过精心设计的架构和完善的机制，为Roo-Code平台提供了强大而灵活的工具管理能力。系统的主要优势包括：

...
- Dodano obsługę OpenAI GPT-5.4 i GPT-5.3 Chat Latest, żebyś mógł używać najnowszych modeli czatu OpenAI w NJUST_AI_CJ.
...
## Co NJUST_AI_CJ może zrobić dla CIEBIE?
...
NJUST_AI_CJ dostosowuje się do Twojego sposobu pracy, a nie odwrotnie:
...
Istnieje kilka sposobów na uruchomienie rozszerzenia NJUST_AI_CJ:

### Tryb deweloperski (F5)

Do aktywnego programowania użyj wbudowanego debugowania VSCode:

Naciśnij `F5` (lub przejdź do **Uruchom** → **Rozpocznij debugowanie**) w VSCode. Otworzy to nowe okno VSCode z uruchomionym rozszerzeniem NJUST_AI_CJ.

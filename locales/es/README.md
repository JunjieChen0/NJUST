...
- Se añadió compatibilidad con OpenAI GPT-5.4 y GPT-5.3 Chat Latest para que puedas usar los modelos de chat más recientes de OpenAI en NJUST_AI_CJ.
...
## ¿Qué puede hacer NJUST_AI_CJ por TI?
...
NJUST_AI_CJ se adapta a tu forma de trabajar, no al revés:
...
Hay varias formas de ejecutar la extensión NJUST_AI_CJ:

### Modo de desarrollo (F5)

Para el desarrollo activo, utiliza la depuración integrada de VSCode:

Presiona `F5` (o ve a **Ejecutar** → **Iniciar depuración**) en VSCode. Esto abrirá una nueva ventana de VSCode con la extensión NJUST_AI_CJ en ejecución.

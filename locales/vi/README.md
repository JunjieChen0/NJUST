...
<p align="center">
  <em>Nhận trợ giúp nhanh → <a href="https://discord.gg/njust-ai-cj">Tham gia Discord</a> • Thích không đồng bộ? → <a href="https://www.reddit.com/r/NJUST_AI_CJ/">Tham gia r/NJUST_AI_CJ</a></em>
</p>
...
- Đã thêm hỗ trợ cho OpenAI GPT-5.4 và GPT-5.3 Chat Latest để bạn có thể dùng các mô hình chat OpenAI mới nhất trong NJUST_AI_CJ.
...
## NJUST_AI_CJ có thể làm gì cho BẠN?
...
NJUST_AI_CJ thích ứng với cách bạn làm việc, chứ không phải ngược lại:
...
Xem thêm: [Sử dụng Chế độ](https://docs.njust-ai-cj.local/basic-usage/using-modes) • [Chế độ tùy chỉnh](https://docs.njust-ai-cj.local/advanced-usage/custom-modes)
...
<p align="center">
<a href="https://docs.njust-ai-cj.local/tutorial-videos">Thêm video hướng dẫn và tính năng nhanh...</a>
</p>

## Tài nguyên

- **[Tài liệu](https://docs.njust-ai-cj.local):** Hướng dẫn chính thức để cài đặt, cấu hình và sử dụng thành thạo NJUST_AI_CJ.
- **[Kênh YouTube](https://youtube.com/@roocodeyt?feature=shared):** Xem các video hướng dẫn và các tính năng đang hoạt động.
- **[Máy chủ Discord](https://discord.gg/njust-ai-cj):** Tham gia cộng đồng để được trợ giúp và thảo luận trong thời gian thực.
- **[Cộng đồng Reddit](https://www.reddit.com/r/NJUST_AI_CJ):** Chia sẻ kinh nghiệm của bạn và xem những người khác đang xây dựng gì.
- **[Vấn đề trên GitHub](https://github.com/NJUST-AI/NJUST_AI_CJ/issues):** Báo cáo lỗi và theo dõi quá trình phát triển.
- **[Yêu cầu tính năng](https://github.com/NJUST-AI/NJUST_AI_CJ/discussions/categories/feature-requests?discussions_q=is%3Aopen+category%3A%22Feature+Requests%22+sort%3Atop):** Có ý tưởng? Hãy chia sẻ với các nhà phát triển.
...
Có một số cách để chạy phần mở rộng NJUST_AI_CJ:

### Chế độ phát triển (F5)

Để phát triển tích cực, hãy sử dụng tính năng gỡ lỗi tích hợp của VSCode:

Nhấn `F5` (hoặc vào **Run** → **Start Debugging**) trong VSCode. Thao tác này sẽ mở một cửa sổ VSCode mới với phần mở rộng NJUST_AI_CJ đang chạy.
...
1.  Đầu tiên, hãy xây dựng gói VSIX:
    ...
    pnpm vsix
    ```
2.  Một tệp `.vsix` sẽ được tạo trong thư mục `bin/` (ví dụ: `bin/njust-ai-cj-<version>.vsix`).
...
**Thưởng thức NJUST_AI_CJ!** Dù bạn giữ nó trong tầm kiểm soát chặt chẽ hay để nó tự do hoạt động, chúng tôi rất nóng lòng muốn xem bạn sẽ xây dựng được gì. Nếu bạn có câu hỏi hoặc ý tưởng về tính năng, hãy ghé qua [cộng đồng Reddit](https://www.reddit.com/r/NJUST_AI_CJ/) hoặc [Discord](https://discord.gg/njust-ai-cj) của chúng tôi. Chúc bạn viết mã vui vẻ!

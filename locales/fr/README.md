...
<p align="center">
  <em>Obtenez de l'aide rapidement → <a href="https://discord.gg/njust-ai-cj">Rejoignez Discord</a> • Vous préférez l'asynchrone ? → <a href="https://www.reddit.com/r/NJUST_AI_CJ/">Rejoignez r/NJUST_AI_CJ</a></em>
</p>
...
- Ajout de la prise en charge d’OpenAI GPT-5.4 et de GPT-5.3 Chat Latest pour que tu puisses utiliser les modèles de chat OpenAI les plus récents dans NJUST_AI_CJ.
...
## Que peut faire NJUST_AI_CJ pour VOUS ?
...
NJUST_AI_CJ s'adapte à votre façon de travailler, pas l'inverse :
...
En savoir plus : [Utiliser les Modes](https://docs.njust-ai-cj.local/basic-usage/using-modes) • [Modes personnalisés](https://docs.njust-ai-cj.local/advanced-usage/custom-modes)
...
<p align="center">
<a href="https://docs.njust-ai-cj.local/tutorial-videos">Plus de tutoriels rapides et de vidéos de fonctionnalités...</a>
</p>

## Ressources

- **[Documentation](https://docs.njust-ai-cj.local):** Le guide officiel pour installer, configurer et maîtriser NJUST_AI_CJ.
...
- **[Serveur Discord](https://discord.gg/njust-ai-cj):** Rejoignez la communauté pour obtenir de l'aide en temps réel et discuter.
- **[Communauté Reddit](https://www.reddit.com/r/NJUST_AI_CJ):** Partagez vos expériences et découvrez ce que les autres construisent.
- **[Problèmes GitHub](https://github.com/NJUST-AI/NJUST_AI_CJ/issues):** Signalez des bugs et suivez le développement.
- **[Demandes de fonctionnalités](https://github.com/NJUST-AI/NJUST_AI_CJ/discussions/categories/feature-requests?discussions_q=is%3Aopen+category%3A%22Feature+Requests%22+sort%3Atop):** Vous avez une idée ? Partagez-la avec les développeurs.
...
Il existe plusieurs façons d'exécuter l'extension NJUST_AI_CJ :

### Mode développement (F5)

Pour un développement actif, utilisez le débogage intégré de VSCode :

Appuyez sur `F5` (ou allez dans **Exécuter** → **Démarrer le débogage**) dans VSCode. Cela ouvrira une nouvelle fenêtre VSCode avec l'extension NJUST_AI_CJ en cours d'exécution.
...
1.  D'abord, compilez le package VSIX :
    ...
    pnpm vsix
    ```
2.  Un fichier `.vsix` sera généré dans le répertoire `bin/` (par exemple, `bin/njust-ai-cj-<version>.vsix`).

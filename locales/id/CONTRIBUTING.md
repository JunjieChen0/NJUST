...
### 3. Bergabunglah dengan Komunitas NJUST_AI_CJ

- **Utama:** Bergabunglah dengan [Discord](https://discord.gg/njust-ai-cj) kami dan kirim DM ke **Hannes Rudolph (`hrudolph`)**.
...
- **Periksa masalah yang ada**: Cari di [Masalah GitHub](https://github.com/NJUST-AI/NJUST_AI_CJ/issues).
...
- **Ingin mengerjakannya?** Beri komentar "Mengklaim" pada masalah tersebut dan kirim DM ke **Hannes Rudolph (`hrudolph`)** di [Discord](https://discord.gg/njust-ai-cj) untuk ditugaskan. Penugasan akan dikonfirmasi di utas.
...
- Untuk dokumentasi, kunjungi [Dokumentasi NJUST_AI_CJ](https://github.com/NJUST-AI/NJUST_AI_CJ-Docs).

### Melaporkan Bug

- Periksa laporan yang ada terlebih dahulu.
- Buat bug baru menggunakan [template "Laporan Bug"](https://github.com/NJUST-AI/NJUST_AI_CJ/issues/new/choose) dengan:
    - Langkah-langkah reproduksi yang jelas dan bernomor
    - Hasil yang diharapkan vs aktual
    - Versi NJUST_AI_CJ (wajib); penyedia/model API jika relevan
- **Masalah keamanan**: Laporkan secara pribadi melalui [saran keamanan](https://github.com/NJUST-AI/NJUST_AI_CJ/security/advisories/new).
...
```
git clone https://github.com/NAMA_PENGGUNA_ANDA/NJUST_AI_CJ.git
```
...
- Harus merujuk pada Masalah GitHub yang ditugaskan. Untuk ditugaskan: beri komentar "Mengklaim" pada masalah tersebut dan kirim DM ke **Hannes Rudolph (`hrudolph`)** di [Discord](https://discord.gg/njust-ai-cj). Penugasan akan dikonfirmasi di utas.
...
Dengan berkontribusi, Anda setuju bahwa kontribusi Anda akan dilisensikan di bawah Lisensi Apache 2.0, sesuai dengan lisensi NJUST_AI_CJ.

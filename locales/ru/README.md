...
- Добавлена поддержка OpenAI GPT-5.4 и GPT-5.3 Chat Latest, чтобы ты мог использовать новейшие чат-модели OpenAI в NJUST_AI_CJ.
...
## Что NJUST_AI_CJ может сделать для ВАС?
...
NJUST_AI_CJ адаптируется к вашему стилю работы, а не наоборот:
...
Существует несколько способов запустить расширение NJUST_AI_CJ:

### Режим разработки (F5)

Для активной разработки используйте встроенную отладку VSCode:

Нажмите `F5` (или перейдите в меню **Выполнить** → **Начать отладку**) в VSCode. Это откроет новое окно VSCode с запущенным расширением NJUST_AI_CJ.

...
### 3. Присоединяйтесь к сообществу NJUST_AI_CJ

- **Основной:** Присоединяйтесь к нашему [Discord](https://discord.gg/njust-ai-cj) и напишите личное сообщение **Hannes Rudolph (`hrudolph`)**.
...
- **Проверьте существующие задачи**: выполните поиск в [задачах GitHub](https://github.com/NJUST-AI/NJUST_AI_CJ/issues).
...
- **Хотите над этим поработать?** Напишите комментарий «Забираю» к задаче и напишите личное сообщение **Hannes Rudolph (`hrudolph`)** в [Discord](https://discord.gg/njust-ai-cj), чтобы вас назначили. Назначение будет подтверждено в ветке.
...
- Для документации посетите [Документацию NJUST_AI_CJ](https://github.com/NJUST-AI/NJUST_AI_CJ-Docs).

### Сообщение об ошибках

- Сначала проверьте существующие отчеты.
- Создайте новую ошибку, используя [шаблон «Отчет об ошибке»](https://github.com/NJUST-AI/NJUST_AI_CJ/issues/new/choose) с:
    - Четкими, пронумерованными шагами воспроизведения
    - Ожидаемым и фактическим результатом
    - Версией NJUST_AI_CJ (обязательно); поставщиком/моделью ИИ, если применимо
- **Проблемы с безопасностью**: сообщайте в частном порядке через [рекомендации по безопасности](https://github.com/NJUST-AI/NJUST_AI_CJ/security/advisories/new).
...
```
git clone https://github.com/ВАШЕ_ИМЯ_ПОЛЬЗОВАТЕЛЯ/NJUST_AI_CJ.git
```
...
- Должен ссылаться на назначенную задачу GitHub. Чтобы вас назначили: напишите комментарий «Забираю» к задаче и напишите личное сообщение **Hannes Rudolph (`hrudolph`)** в [Discord](https://discord.gg/njust-ai-cj). Назначение будет подтверждено в ветке.
...
Внося свой вклад, вы соглашаетесь с тем, что ваши вклады будут лицензироваться по лицензии Apache 2.0, в соответствии с лицензированием NJUST_AI_CJ.

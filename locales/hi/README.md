...
<p align="center">
  <em>जल्दी मदद पाएं → <a href="https://discord.gg/njust-ai-cj">डिस्कॉर्ड से जुड़ें</a> • एसिंक पसंद है? → <a href="https://www.reddit.com/r/NJUST_AI_CJ/">r/NJUST_AI_CJ से जुड़ें</a></em>
</p>
...
- OpenAI GPT-5.4 और GPT-5.3 Chat Latest के लिए सपोर्ट जोड़ा गया है, ताकि आप NJUST_AI_CJ में OpenAI के सबसे नए chat models इस्तेमाल कर सकें।
...
## NJUST_AI_CJ आपके लिए क्या कर सकता है?
...
और जानो: [मोड्स का इस्तेमाल](https://docs.njust-ai-cj.local/basic-usage/using-modes) • [कस्टम मोड्स](https://docs.njust-ai-cj.local/advanced-usage/custom-modes)
...
<p align="center">
<a href="https://docs.njust-ai-cj.local/tutorial-videos">अधिक त्वरित ट्यूटोरियल और फ़ीचर वीडियो...</a>
</p>

## संसाधन

- **[दस्तावेज़ीकरण](https://docs.njust-ai-cj.local):** NJUST_AI_CJ को स्थापित करने, कॉन्फ़िगर करने और उसमें महारत हासिल करने के लिए आधिकारिक गाइड।
- **[यूट्यूब चैनल](https://youtube.com/@roocodeyt?feature=shared):** ट्यूटोरियल देखें और सुविधाओं को एक्शन में देखें।
- **[डिस्कॉर्ड सर्वर](https://discord.gg/njust-ai-cj):** रीयल-टाइम सहायता और चर्चा के लिए समुदाय में शामिल हों।
- **[रेडिट समुदाय](https://www.reddit.com/r/NJUST_AI_CJ):** अपने अनुभव साझा करें और देखें कि दूसरे क्या बना रहे हैं।
- **[गिटहब मुद्दे](https://github.com/NJUST-AI/NJUST_AI_CJ/issues):** बग की रिपोर्ट करें और विकास को ट्रैक करें।
- **[सुविधा अनुरोध](https://github.com/NJUST-AI/NJUST_AI_CJ/discussions/categories/feature-requests?discussions_q=is%3Aopen+category%3A%22Feature+Requests%22+sort%3Atop):** क्या आपके पास कोई विचार है? इसे डेवलपर्स के साथ साझा करें।
...
वीएसकोड में `F5` दबाएं (या **रन** → **डीबगिंग प्रारंभ करें** पर जाएं)। यह NJUST_AI_CJ एक्सटेंशन के साथ एक नई वीएसकोड विंडो खोलेगा।
...
1.  पहले, VSIX पैकेज बनाएं:
    ...
    pnpm vsix
    ```
2.  `bin/` डायरेक्टरी में एक `.vsix` फ़ाइल जनरेट होगी (जैसे, `bin/njust-ai-cj-<version>.vsix` )।

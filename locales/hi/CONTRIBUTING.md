...
### 3. NJUST_AI_CJ समुदाय में शामिल हों

- **प्राथमिक:** हमारे [डिस्कॉर्ड](https://discord.gg/njust-ai-cj) में शामिल हों और **Hannes Rudolph (`hrudolph`)** को डीएम करें।
...
- **मौजूदा समस्याओं की जाँच करें**: [गिटहब समस्याएँ](https://github.com/NJUST-AI/NJUST_AI_CJ/issues) में खोजें।
...
- **इस पर काम करना चाहते हैं?** समस्या पर "दावा करना" टिप्पणी करें और असाइन होने के लिए [डिस्कॉर्ड](https://discord.gg/njust-ai-cj) पर **Hannes Rudolph (`hrudolph`)** को डीएम करें। असाइनमेंट की पुष्टि थ्रेड में की जाएगी।
...
- दस्तावेज़ों के लिए, [NJUST_AI_CJ दस्तावेज़](https://github.com/NJUST-AI/NJUST_AI_CJ-Docs) पर जाएँ।

### बग की रिपोर्ट करना

- पहले मौजूदा रिपोर्ट की जाँच करें।
- ["बग रिपोर्ट" टेम्पलेट](https://github.com/NJUST-AI/NJUST_AI_CJ/issues/new/choose) का उपयोग करके एक नया बग बनाएँ:
    - स्पष्ट, क्रमांकित पुनरुत्पादन चरण
    - अपेक्षित बनाम वास्तविक परिणाम
    - NJUST_AI_CJ संस्करण (आवश्यक); यदि प्रासंगिक हो तो एपीआई प्रदाता/मॉडल
- **सुरक्षा समस्याएँ**: [सुरक्षा सलाहकारों](https://github.com/NJUST-AI/NJUST_AI_CJ/security/advisories/new) के माध्यम से निजी तौर पर रिपोर्ट करें।
...
```
git clone https://github.com/आपका_उपयोगकर्ता_नाम/NJUST_AI_CJ.git
```
...
- एक असाइन की गई गिटहब समस्या का संदर्भ देना होगा। असाइन होने के लिए: समस्या पर "दावा करना" टिप्पणी करें और [डिस्कॉर्ड](https://discord.gg/njust-ai-cj) पर **Hannes Rudolph (`hrudolph`)** को डीएम करें। असाइनमेंट की पुष्टि थ्रेड में की जाएगी।
...
योगदान करके, आप सहमत हैं कि आपके योगदान अपाचे 2.0 लाइसेंस के तहत लाइसेंस प्राप्त होंगे, जो NJUST_AI_CJ के लाइसेंस के अनुरूप है।

...
- NJUST_AI_CJ içinde en yeni OpenAI sohbet modellerini kullanabilmen için OpenAI GPT-5.4 ve GPT-5.3 Chat Latest desteği eklendi.
...
## NJUST_AI_CJ SİZİN İçin Ne Yapabilir?
...
NJUST_AI_CJ, sizin çalışma şeklinize uyum sağlar, tam tersi değil:
...
NJUST_AI_CJ uzantısını çalıştırmanın birkaç yolu vardır:

### Geliştirme Modu (F5)

Aktif geliştirme için VSCode'un yerleşik hata ayıklama özelliğini kullanın:

VSCode'da `F5` tuşuna basın (veya **Çalıştır** → **Hata Ayıklamayı Başlat**'a gidin). Bu, NJUST_AI_CJ uzantısının çalıştığı yeni bir VSCode penceresi açacaktır.

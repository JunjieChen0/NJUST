...
This package provides IPC functionality for NJUST_AI_CJ, allowing external applications to communicate with the extension through a socket-based interface.
...
- `configuration`: NJUST_AI_CJ settings object
